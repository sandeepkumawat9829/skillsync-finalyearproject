...
describe('ShowcaseService', () => {
    ...
    describe('getGallery', () => {
        it('should fetch gallery with default parameters', () => {
            ...
            const req = httpMock.expectOne('/api/showcase?page=0&size=12&sortBy=recent');
        ...
        it('should fetch gallery with custom parameters', () => {
            ...
            const req = httpMock.expectOne('/api/showcase?page=1&size=20&sortBy=popular');
            expect(req.request.method).toBe('GET');
            req.flush([mockShowcase]);
        });
    });
    ...
    describe('getShowcase', () => {
        it('should fetch single showcase by ID', () => {
            ...
            const req = httpMock.expectOne('/api/showcase/1');
            expect(req.request.method).toBe('GET');
            req.flush(mockShowcase);
        });
    });
    ...
    describe('publishProject', () => {
        it('should send POST request to publish project', () => {
            ...
            const req = httpMock.expectOne('/api/showcase/projects/1/publish');
    ...
    describe('toggleLike', () => {
        it('should send POST request to toggle like', () => {
            ...
            const req = httpMock.expectOne('/api/showcase/1/like');
            expect(req.request.method).toBe('POST');
    ...
    describe('search', () => {
        it('should search showcases with default parameters', () => {
            ...
            const req = httpMock.expectOne('/api/showcase/search?q=AI&page=0&size=12');
            expect(req.request.method).toBe('GET');
            req.flush([mockShowcase]);
        });
        ...
        it('should search showcases with custom pagination', () => {
            ...
            const req = httpMock.expectOne('/api/showcase/search?q=ML&page=2&size=24');
            expect(req.request.method).toBe('GET');
            req.flush([mockShowcase]);
        });
    });
