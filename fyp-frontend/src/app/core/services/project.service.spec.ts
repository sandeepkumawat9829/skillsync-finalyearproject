...
describe('ProjectService', () => {
    ...
    describe('getProjects', () => {
        it('should fetch public projects', () => {
            ...
            const req = httpMock.expectOne('/api/projects/public');
        ...
        it('should send filters as query params', () => {
            ...
            const req = httpMock.expectOne(request =>
                request.url === '/api/projects/public' &&
    ...
    describe('getProjectBuckets', () => {
        it('should fetch project buckets', () => {
            ...
            const req = httpMock.expectOne('/api/projects/buckets');
            expect(req.request.method).toBe('GET');
            req.flush(buckets);
        });
    ...
    describe('getMyProjects', () => {
        it('should fetch current user projects', () => {
            ...
            const req = httpMock.expectOne('/api/projects/my');
            expect(req.request.method).toBe('GET');
            req.flush(mockProjects);
        });
    });
    ...
    describe('getProjectsByStatus', () => {
        it('should fetch projects filtered by status', () => {
            ...
            const req = httpMock.expectOne('/api/projects/status/COMPLETED');
            expect(req.request.method).toBe('GET');
            req.flush(mockProjects);
        });
    });
