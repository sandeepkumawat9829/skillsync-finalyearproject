...
describe('SprintService', () => {
    ...
    describe('getSprintsByProject', () => {
        it('should fetch sprints by project ID', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/sprints/project/1');
    ...
    describe('getActiveSprint', () => {
        it('should fetch active sprint for project', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/sprints/project/1/active');
            expect(req.request.method).toBe('GET');
            req.flush(mockSprint);
        });
    ...
    describe('getSprintById', () => {
        it('should fetch sprint by ID', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/sprints/1');
            expect(req.request.method).toBe('GET');
            req.flush(mockSprint);
        });
    });
    ...
    describe('createSprint', () => {
        it('should send POST request to create sprint', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/sprints');
    ...
    describe('startSprint', () => {
        it('should send POST request to start sprint', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/sprints/1/start');
            expect(req.request.method).toBe('POST');
            req.flush(mockSprint);
        });
    });
    ...
    describe('completeSprint', () => {
        it('should send POST request to complete sprint', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/sprints/1/complete');
            expect(req.request.method).toBe('POST');
            req.flush(mockSprint);
        });
    });
    ...
    describe('getSprintRetrospective', () => {
        it('should fetch sprint retrospective', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/sprints/1/retrospective');
            expect(req.request.method).toBe('GET');
    ...
    describe('getBurndownData', () => {
        it('should fetch burndown chart data', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/sprints/1/burndown');
            expect(req.request.method).toBe('GET');
