...
describe('AnalyticsService', () => {
    ...
    describe('getProjectAnalytics', () => {
        it('should fetch complete project analytics', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/analytics/project/1');
    ...
    describe('getBurndownData', () => {
        it('should fetch burndown data for sprint', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/analytics/project/1/burndown?sprintId=5');
            expect(req.request.method).toBe('GET');
    ...
    describe('getVelocityData', () => {
        it('should fetch velocity data', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/analytics/project/1/velocity');
            expect(req.request.method).toBe('GET');
    ...
    describe('getContributionData', () => {
        it('should fetch contribution data', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/analytics/project/1/contributions');
            expect(req.request.method).toBe('GET');
    ...
    describe('getSprintMetrics', () => {
        it('should fetch sprint metrics', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/analytics/project/1/sprint-metrics');
            expect(req.request.method).toBe('GET');
            req.flush([]);
        });
    });
    ...
    describe('getAnalyticsOverview', () => {
        it('should fetch analytics overview', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/analytics/project/1/overview');
            expect(req.request.method).toBe('GET');
    ...
    describe('getTimeBasedMetrics', () => {
        it('should fetch time-based metrics with default days', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/analytics/project/1/time-metrics?days=30');
            expect(req.request.method).toBe('GET');
            req.flush([]);
        });
        ...
        it('should fetch time-based metrics with custom days', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/analytics/project/1/time-metrics?days=60');
            expect(req.request.method).toBe('GET');
            req.flush([]);
        });
    });
