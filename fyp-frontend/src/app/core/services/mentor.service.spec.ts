...
describe('MentorService', () => {
    ...
    describe('getAllMentors', () => {
        it('should fetch all mentors', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors');
    ...
    describe('getAvailableMentors', () => {
        it('should fetch available mentors', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/available');
            expect(req.request.method).toBe('GET');
            req.flush([mockMentor]);
        });
    });
    ...
    describe('getMentorById', () => {
        it('should fetch mentor by ID', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/1');
            expect(req.request.method).toBe('GET');
            req.flush(mockMentor);
        });
    });
    ...
    describe('searchMentors', () => {
        it('should search mentors by query', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/search?q=AI');
            expect(req.request.method).toBe('GET');
            req.flush([mockMentor]);
        });
        ...
        it('should encode special characters in search query', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/search?q=AI%20%26%20ML');
            req.flush([mockMentor]);
        });
    });
    ...
    describe('sendMentorRequest', () => {
        it('should send POST request to request mentor', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/request');
    ...
    describe('getMyRequests', () => {
        it('should fetch student mentor requests', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/requests/my');
            expect(req.request.method).toBe('GET');
            req.flush([mockMentorRequest]);
        });
    });
    ...
    describe('cancelRequest', () => {
        it('should send DELETE request to cancel mentor request', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/requests/1');
    ...
    describe('getMentorStats', () => {
        it('should fetch mentor statistics', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/1/stats');
            expect(req.request.method).toBe('GET');
            req.flush(stats);
        });
    });
    ...
    describe('getPendingMentorRequests', () => {
        it('should fetch pending requests for mentor', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/requests/pending');
            expect(req.request.method).toBe('GET');
            req.flush([mockMentorRequest]);
        });
    });
    ...
    describe('acceptMentorRequest', () => {
        it('should send POST request to accept mentor request', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/requests/1/accept');
            expect(req.request.method).toBe('POST');
    ...
    describe('rejectMentorRequest', () => {
        it('should send POST request to reject mentor request', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/requests/1/reject');
            expect(req.request.method).toBe('POST');
    ...
    describe('getAssignedTeams', () => {
        it('should fetch assigned teams for mentor', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/1/teams');
            expect(req.request.method).toBe('GET');
            req.flush([]);
        });
    });
    ...
    describe('getMyAssignments', () => {
        it('should fetch mentor assignments for current mentor', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/mentors/assignments');
            expect(req.request.method).toBe('GET');
            req.flush([]);
        });
    });
