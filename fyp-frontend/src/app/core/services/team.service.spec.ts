...
describe('TeamService', () => {
    ...
    describe('getTeamByProject', () => {
        it('should fetch team by project ID', () => {
            ...
            const req = httpMock.expectOne('/api/teams/project/1');
    ...
    describe('getMyTeam', () => {
        it('should fetch current user team', () => {
            ...
            const req = httpMock.expectOne('/api/teams/my');
            expect(req.request.method).toBe('GET');
            req.flush(mockTeam);
        });
    });
    ...
    describe('getIncompleteTeams', () => {
        it('should fetch teams that can accept new members', () => {
            ...
            const req = httpMock.expectOne('/api/teams/incomplete');
            expect(req.request.method).toBe('GET');
    ...
    describe('sendInvitation', () => {
        it('should send POST request to invite member', () => {
            ...
            const req = httpMock.expectOne('/api/teams/1/invite');
    ...
    describe('getMyInvitations', () => {
        it('should fetch pending invitations for current user', () => {
            ...
            const req = httpMock.expectOne('/api/teams/invitations');
            expect(req.request.method).toBe('GET');
    ...
    describe('acceptInvitation', () => {
        it('should send POST request to accept invitation', () => {
            ...
            const req = httpMock.expectOne('/api/teams/invitations/1/accept');
            expect(req.request.method).toBe('POST');
    ...
    describe('rejectInvitation', () => {
        it('should send POST request to reject invitation', () => {
            ...
            const req = httpMock.expectOne('/api/teams/invitations/1/reject');
            expect(req.request.method).toBe('POST');
            req.flush(null);
        });
    });
    ...
    describe('removeMember', () => {
        it('should send DELETE request to remove member from team', () => {
            ...
            const req = httpMock.expectOne('/api/teams/1/members/2');
