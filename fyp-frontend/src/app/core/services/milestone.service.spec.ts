...
describe('MilestoneService', () => {
    ...
    describe('getProjectMilestones', () => {
        it('should fetch milestones by project ID', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/milestones/project/1');
    ...
    describe('getMilestone', () => {
        it('should fetch single milestone by ID', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/milestones/1');
            expect(req.request.method).toBe('GET');
            req.flush(mockMilestone);
        });
    });
    ...
    describe('createMilestone', () => {
        it('should send POST request to create milestone', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/milestones');
    ...
    describe('updateStatus', () => {
        it('should send POST request to update status', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/milestones/1/status');
            expect(req.request.method).toBe('POST');
    ...
    describe('completeMilestone', () => {
        it('should send POST request to complete milestone', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/milestones/1/complete');
            expect(req.request.method).toBe('POST');
            req.flush(mockMilestone);
        });
    });
    ...
    describe('addMentorReview', () => {
        it('should send POST request to add mentor review', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/milestones/1/review');
            expect(req.request.method).toBe('POST');
    ...
    describe('getOverdueMilestones', () => {
        it('should fetch overdue milestones', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/milestones/project/1/overdue');
            expect(req.request.method).toBe('GET');
            req.flush([mockMilestone]);
        });
    });
    ...
    describe('getPendingReviews', () => {
        it('should fetch pending review milestones', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/milestones/project/1/pending-reviews');
            expect(req.request.method).toBe('GET');
            req.flush([mockMilestone]);
        });
    });
    ...
    describe('getProjectProgress', () => {
        it('should fetch project progress', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/milestones/project/1/progress');
            expect(req.request.method).toBe('GET');
