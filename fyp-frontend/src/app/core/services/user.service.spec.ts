...
describe('UserService', () => {
    ...
    describe('getMyProfile', () => {
        it('should fetch current user profile', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/users/profile');
    ...
    describe('getDashboard', () => {
        it('should fetch dashboard data', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/users/dashboard');
            expect(req.request.method).toBe('GET');
    ...
    describe('searchStudents', () => {
        it('should search students by query', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/users/students/search?q=John');
            expect(req.request.method).toBe('GET');
            req.flush([mockProfile]);
        });
        ...
        it('should include branch filter when provided', () => {
            ...
            const req = httpMock.expectOne(
                'https://skillsync-finalyearproject.onrender.com/api/users/students/search?q=John&branch=Computer%20Science'
            );
            expect(req.request.method).toBe('GET');
            req.flush([mockProfile]);
        });
        ...
        it('should include semester filter when provided', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/users/students/search?q=John&semester=6');
            expect(req.request.method).toBe('GET');
            req.flush([mockProfile]);
        });
        ...
        it('should include both filters when provided', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/users/students/search?q=John&branch=CS&semester=6');
            expect(req.request.method).toBe('GET');
            req.flush([mockProfile]);
        });
        ...
        it('should encode special characters in query', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/users/students/search?q=John%20%26%20Jane');
            req.flush([]);
        });
    });
    ...
    describe('getStudentById', () => {
        it('should fetch student by ID', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/users/students/1');
            expect(req.request.method).toBe('GET');
            req.flush(mockProfile);
        });
    });
