...
describe('TemplateService', () => {
    ...
    describe('getAllTemplates', () => {
        it('should fetch all templates', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/templates');
    ...
    describe('getTemplatesByDomain', () => {
        it('should fetch templates by domain', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/templates/domain/Web Development');
            expect(req.request.method).toBe('GET');
            req.flush([mockTemplate]);
        });
    });
    ...
    describe('getTemplate', () => {
        it('should fetch single template by ID', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/templates/1');
            expect(req.request.method).toBe('GET');
            req.flush(mockTemplate);
        });
    });
