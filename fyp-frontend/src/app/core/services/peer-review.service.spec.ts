...
describe('PeerReviewService', () => {
    ...
    describe('submitReview', () => {
        it('should send POST request to submit review', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/peer-reviews');
    ...
    describe('getMyFeedback', () => {
        it('should fetch feedback received for a project', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/peer-reviews/projects/1/my-feedback');
    ...
    describe('getMySubmittedReviews', () => {
        it('should fetch reviews submitted by current user', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/peer-reviews/my-reviews');
            expect(req.request.method).toBe('GET');
            req.flush([mockReview]);
        });
    });
    ...
    describe('getMySummary', () => {
        it('should fetch current user review summary', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/peer-reviews/my-summary');
            expect(req.request.method).toBe('GET');
    ...
    describe('getUserSummary', () => {
        it('should fetch user summary by ID (for mentors)', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/peer-reviews/users/1/summary');
            expect(req.request.method).toBe('GET');
            req.flush(mockSummary);
        });
    });
