...
describe('GitHubService', () => {
    ...
    describe('syncCommits', () => {
        it('should send POST request to sync commits', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/github/projects/1/sync');
    ...
    describe('getStats', () => {
        it('should fetch GitHub stats for project', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/github/projects/1/stats');
    ...
    describe('getCommits', () => {
        it('should fetch commits with default pagination', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/github/projects/1/commits?page=0&size=20');
            expect(req.request.method).toBe('GET');
        ...
        it('should fetch commits with custom pagination', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/github/projects/1/commits?page=2&size=50');
            expect(req.request.method).toBe('GET');
            req.flush([mockCommit]);
        });
    });
