...
describe('MeetingService', () => {
    ...
    describe('getAllMeetings', () => {
        it('should fetch all meetings', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/meetings');
    ...
    describe('getMeetingsByTeam', () => {
        it('should fetch meetings by team ID', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/meetings/team/1');
            expect(req.request.method).toBe('GET');
            req.flush([mockMeeting]);
        });
    });
    ...
    describe('getUpcomingMeetings', () => {
        it('should fetch upcoming meetings', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/meetings/upcoming');
            expect(req.request.method).toBe('GET');
            req.flush([mockMeeting]);
        });
    });
    ...
    describe('getPastMeetings', () => {
        it('should fetch past meetings', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/meetings/past');
            expect(req.request.method).toBe('GET');
            req.flush([mockMeeting]);
        });
    });
    ...
    describe('getMeetingById', () => {
        it('should fetch meeting by ID', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/meetings/1');
            expect(req.request.method).toBe('GET');
            req.flush(mockMeeting);
        });
    });
    ...
    describe('addMeetingNotes', () => {
        it('should send POST request to add meeting notes', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/meetings/1/notes');
            expect(req.request.method).toBe('POST');
    ...
    describe('cancelMeeting', () => {
        it('should send POST request to cancel meeting', () => {
            ...
            const req = httpMock.expectOne('https://skillsync-finalyearproject.onrender.com/api/meetings/1/cancel');
            expect(req.request.method).toBe('POST');
            req.flush(null);
        });
    });
    ...
    describe('downloadIcs', () => {
        it('should open ICS download URL', () => {
            ...
            expect(window.open).toHaveBeenCalledWith('https://skillsync-finalyearproject.onrender.com/api/meetings/1/ics', '_blank');
        });
    });
});
