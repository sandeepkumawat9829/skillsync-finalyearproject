...
describe('ResourceService', () => {
    ...
    describe('createResource', () => {
        it('should send POST request to create resource', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/resources');
    ...
    describe('getTeamResources', () => {
        it('should fetch team resources without filters', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/resources/teams/1');
        ...
        it('should fetch team resources with type filter', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/resources/teams/1?type=TUTORIAL');
            expect(req.request.method).toBe('GET');
            req.flush([mockResource]);
        });
        ...
        it('should fetch team resources with phase filter', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/resources/teams/1?phase=DEVELOPMENT');
            expect(req.request.method).toBe('GET');
            req.flush([mockResource]);
        });
        ...
        it('should fetch team resources with both filters', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/resources/teams/1?type=TUTORIAL&phase=DEVELOPMENT');
            expect(req.request.method).toBe('GET');
            req.flush([mockResource]);
        });
    });
    ...
    describe('deleteResource', () => {
        it('should send DELETE request', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/resources/1');
