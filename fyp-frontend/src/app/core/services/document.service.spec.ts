...
describe('DocumentService', () => {
    ...
    describe('getDocumentsByProject', () => {
        it('should fetch documents by project ID', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/documents/project/1');
    ...
    describe('getDocumentById', () => {
        it('should fetch document by ID', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/documents/1');
            expect(req.request.method).toBe('GET');
            req.flush(mockDocument);
        });
    });
    ...
    describe('uploadDocument', () => {
        it('should send POST request with FormData to upload document', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/documents/project/1/upload');
    ...
    describe('approveDocument', () => {
        it('should send POST request to approve document', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/documents/1/approve');
            expect(req.request.method).toBe('POST');
            req.flush(mockDocument);
        });
    });
    ...
    describe('rejectDocument', () => {
        it('should send POST request to reject document with reason', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/documents/1/reject');
            expect(req.request.method).toBe('POST');
