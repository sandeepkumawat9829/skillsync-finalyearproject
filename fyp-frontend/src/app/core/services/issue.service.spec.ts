...
describe('IssueService', () => {
    ...
    describe('getIssuesByProject', () => {
        it('should fetch issues by project ID', () => {
            ...
            const req = httpMock.expectOne('/api/issues/project/1');
    ...
    describe('assignIssue', () => {
        it('should send PUT request to assign issue', () => {
            ...
            const req = httpMock.expectOne('/api/issues/1/assign');
            expect(req.request.method).toBe('PUT');
    ...
    describe('linkTask', () => {
        it('should send POST request to link issue to task', () => {
            ...
            const req = httpMock.expectOne('/api/issues/1/link-task/10');
            expect(req.request.method).toBe('POST');
            req.flush(mockIssue);
        });
    });
    ...
    describe('addComment', () => {
        it('should send POST request to add comment', () => {
            ...
            const req = httpMock.expectOne('/api/issues/1/comments');
            expect(req.request.method).toBe('POST');
