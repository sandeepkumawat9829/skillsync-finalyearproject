...
describe('AdminService', () => {
    ...
    describe('getUsers', () => {
        ...
        it('should fetch users filtered by role', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/admin/users?role=STUDENT');
            expect(req.request.method).toBe('GET');
            req.flush(users);
        });
        ...
        it('should fetch mentors when role is MENTOR', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/admin/users?role=MENTOR');
            req.flush(mentors);
        });
    });
    ...
    describe('toggleUserStatus', () => {
        it('should send PUT request to toggle user status', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/admin/users/1/toggle-status');
    ...
    describe('enableUser', () => {
        it('should send PUT request to enable user', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/admin/users/1/enable');
            expect(req.request.method).toBe('PUT');
            req.flush(null);
        });
    });
    ...
    describe('disableUser', () => {
        it('should send PUT request to disable user', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/admin/users/1/disable');
            expect(req.request.method).toBe('PUT');
            req.flush(null);
        });
    });
    ...
    describe('getProjectBuckets', () => {
        it('should fetch project buckets', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/admin/buckets');
            expect(req.request.method).toBe('GET');
            req.flush(buckets);
        });
    });
    ...
    describe('updateBucket', () => {
        it('should send PUT request to update bucket', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/admin/buckets/1');
            expect(req.request.method).toBe('PUT');
    ...
    describe('getTeamsWithoutMentor', () => {
        it('should fetch teams without assigned mentor', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/admin/teams/without-mentor');
            expect(req.request.method).toBe('GET');
            req.flush(teams);
        });
    });
    ...
    describe('forceAssignMentor', () => {
        it('should send POST request to assign mentor', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/admin/teams/1/assign-mentor');
            expect(req.request.method).toBe('POST');
