...
describe('BucketService', () => {
    ...
    describe('getAvailableBuckets', () => {
        it('should fetch available buckets', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/buckets');
    ...
    describe('getAllBuckets', () => {
        it('should fetch all buckets', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/buckets/all');
            expect(req.request.method).toBe('GET');
            req.flush([mockBucket]);
        });
    });
    ...
    describe('getBucketsByDepartment', () => {
        it('should fetch buckets by department', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/buckets/department/Computer Science');
            expect(req.request.method).toBe('GET');
            req.flush([mockBucket]);
        });
    });
    ...
    describe('getBucketsByDifficulty', () => {
        it('should fetch buckets by difficulty', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/buckets/difficulty/HARD');
            expect(req.request.method).toBe('GET');
            req.flush([mockBucket]);
        });
    });
    ...
    describe('getBucket', () => {
        it('should fetch single bucket by ID', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/buckets/1');
            expect(req.request.method).toBe('GET');
            req.flush(mockBucket);
        });
    });
    ...
    describe('createBucket', () => {
        it('should send POST request to create bucket', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/buckets?userId=1');
    ...
    describe('allocateTeam', () => {
        it('should send POST request to allocate team', () => {
            ...
            const req = httpMock.expectOne('https://outermost-leisha-noncoherently.ngrok-free.de/api/buckets/1/allocate');
            expect(req.request.method).toBe('POST');
            req.flush(mockBucket);
        });
    });
