...
describe('SkillCatalogService', () => {
    ...
    describe('getCategories', () => {
        it('should fetch skill categories', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/skills/categories');
            expect(req.request.method).toBe('GET');
    ...
    describe('getSkillsByCategory', () => {
        it('should fetch skills by category', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/skills/category/FRONTEND');
            expect(req.request.method).toBe('GET');
            req.flush([mockSkill]);
        });
    });
    ...
    describe('getSkill', () => {
        it('should fetch single skill by ID', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/skills/1');
            expect(req.request.method).toBe('GET');
            req.flush(mockSkill);
        });
    });
    ...
    describe('getStudentSkills', () => {
        it('should fetch student skills', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/skills/student/1');
            expect(req.request.method).toBe('GET');
    ...
    describe('removeStudentSkill', () => {
        it('should send DELETE request to remove student skill', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/skills/student/1/skill/1');
    ...
    describe('getMentorSpecializations', () => {
        it('should fetch mentor specializations', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/skills/mentor/1');
            expect(req.request.method).toBe('GET');
            req.flush([mockSkill]);
        });
    });
    ...
    describe('addMentorSpecialization', () => {
        it('should send POST request to add mentor specialization', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/skills/mentor/1/skill/1');
            expect(req.request.method).toBe('POST');
            req.flush(null);
        });
    });
    ...
    describe('findStudentsWithSkills', () => {
        it('should send POST request to find students with skills', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/skills/search/students');
            expect(req.request.method).toBe('POST');
    ...
    describe('findMentorsWithSkills', () => {
        it('should send POST request to find mentors with skills', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/skills/search/mentors');
            expect(req.request.method).toBe('POST');
            req.flush([1, 2]);
        });
    });
    ...
    describe('getTeamSkillGraph', () => {
        it('should fetch team skill analytics', () => {
            ...
            const req = httpMock.expectOne('http://localhost:8080/api/skills/teams/1/skill-graph');
            expect(req.request.method).toBe('GET');
